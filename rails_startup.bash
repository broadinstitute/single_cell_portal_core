...
for ENV_VAR in GA_TRACKING_ID GCP_NETWORK_NAME GCP_SUB_NETWORK_NAME LOGSTASH_HOST MIXPANEL_SECRET MONGODB_ADMIN_PASSWORD \
  GOOGLE_CLOUD_KEYFILE_JSON GOOGLE_PRIVATE_KEY GOOGLE_CLIENT_EMAIL GOOGLE_CLIENT_ID GOOGLE_CLOUD_PROJECT GOOGLE_PROJECT_NUMBER \
  ...
  PROD_DATABASE_PASSWORD PROD_HOSTNAME SECRET_KEY_BASE SENDGRID_PASSWORD SENDGRID_USERNAME APP_INTERNAL_IP
do
...
then
  echo "*** ADDING EMAIL REPORT CRONTABS ***"
  ...
  (crontab -u app -l ; echo "0 9 1 * * . /home/app/.cron_env ; cd /home/app/webapp/; /home/app/webapp/bin/rails runner -e $PASSENGER_APP_ENV \"SingleCellMailer.data_retention_policy_report.deliver_now\" >> /home/app/webapp/log/cron_out.log 2>&1") | crontab -u app -
  echo "*** COMPLETED ***"
fi

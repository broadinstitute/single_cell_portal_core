...
export default function LoadingSpinner({
  children, testId, isLoading, className='gene-load-spinner', height
}) {
  ...
  const spinner = <FontAwesomeIcon icon={faDna} className={fullClassName} data-testid={testId} style={style}/>

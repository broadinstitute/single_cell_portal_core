...
export const PROCESSED_MATRIX_FILE = {
  '_id': {
...
export const COORDINATE_LABEL_FILE = {
  ...
  options: { cluster_file_id: '618acc33cc7ba038ac7cb082' },
  parse_status: 'parsed',
  queued_for_deletion: false,
  remote_location: '',
  spatial_cluster_associations: [''],
  ...
  upload_file_name: 'coordinate_labels.tsv',
  upload_file_size: 85,
  use_metadata_convention: false,
  version: 2,
  x_axis_label: '',
...
export const FASTQ_FILE = {
  created_at: '2021-11-09T12:23:35.683-05:00',
  data_dir: 'b15d47cea457291533045ec99d4d5260f757c2c47a4faad43d05dbc1e5a78b9b',
  description: '',
  file_type: 'Fastq',
  generation: '1636478627761794',
  genome_annotation_id: null,
  ...
  updated_at: '2021-11-09T12:23:47.651-05:00',
  upload: { 'url': 'fake/app/original/foo.fastq' },
  upload_content_type: 'application/gzip',
  upload_file_name: 'sample1.fastq',
  upload_file_size: 5586,
  use_metadata_convention: false,
  version: 1,
  x_axis_label: '',
  x_axis_max: null,

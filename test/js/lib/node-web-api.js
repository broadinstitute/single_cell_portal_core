...
export const nodeCaches = {
  ...
  open: jest.fn((cacheName) => {
    ...
    console.log('nodeCaches._cacheStores[cacheName]', nodeCaches._cacheStores[cacheName])
    ...
    return Promise.resolve({
      ...
      keys: jest.fn(() => {
        console.log('in keys, nodeCaches._cacheStores', nodeCaches._cacheStores)
  ...
  keys: jest.fn(() => {
    ...
    console.log('in nodeCaches._cacheStores', nodeCaches._cacheStores)
    return Promise.resolve(Object.keys(nodeCaches._cacheStores).flatMap(cacheName =>
      Object.keys(nodeCaches._cacheStores[cacheName]).map(key => new Request(key))
    ));
  }),
};
